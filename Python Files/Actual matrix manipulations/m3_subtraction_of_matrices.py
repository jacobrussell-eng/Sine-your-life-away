...
new_top_left = (top_left_A - top_left_B)
new_top_right = (top_right_A - top_right_B)
new_bottom_left = (bottom_left_A - bottom_left_B)
new_bottom_right = (bottom_right_A - bottom_right_B)
...
print(B)
print('')
print('This is the resultant matrix from subtracting the two former: ')
print('')
print(Z)
